...
const navbar = (login="login",signup="signup") => {
    return `    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="/Project/index.html">Home</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="/Project/html/product.html" >Products</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Project/html/addproduct.html" >Add-Products</a>
                    </li>
                    <li class="nav-item">
